...
import { TrendingUp, TrendingDown, Loader2, Shield, XCircle } from 'lucide-react';
    ...
    <>
      ...
      {reviewingRec && (
        <ApprovalDialog
          ...
          isApproving={approvingId === reviewingRec.id}
          onConfirm={() => {
            onApprove(reviewingRec.id);
            setReviewingRec(null);
          }}
          onCancel={() => setReviewingRec(null)}
          onReject={() => {
            onReject(reviewingRec.id);
            setReviewingRec(null);
          }}
        />
      )}
