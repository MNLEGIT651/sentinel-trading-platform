...
| T6.2 | done | Codex | `work` | `docs/deployment.md`, `docs/ai/state/project-state.md` | `git diff --check` | 2026-03-21 | Added an engine Docker appendix that corrects build-context-relative COPY guidance and scopes lockfile-first packaging follow-up. |
