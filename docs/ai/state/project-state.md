...
| T7.1                     | done   | Codex | `work`                             | `docs/analysis/2026-03-21-deployment-followups.md`, `docs/ai/state/project-state.md`                                          | `git diff --check`                                                                                                                                                                      | 2026-03-21   | Reorganized the deployment follow-up write-up into immediate repo-proven correctness fixes vs optional medium-term optimizations, and removed wording that implied unsupported snippets.                        |
